...
},
{
  ...
  options: ["Por pinocitose", "Por difusão através das membranas traqueais", " Por condução direta através dos alvéolos", "Por meio da ventilação pulmonar"],
  correctAnswer: 3,
},
{
...
},
{
  ...
  options: ["Nos pulmões, ocorre a hematose", "O pulmão é revestido pela pleura", "O pulmão esquerdo é menor que o direito", "A pleura parietal e visceral estão unidas"],
  correctAnswer: 3,
},
{
